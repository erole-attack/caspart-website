      ...
      <div className={css(headerStyles.menu)}>
        ...
        <div className={css(headerStyles.menu_items_container)}>
          <ul className={css(headerStyles.menu_items)}>
            <li><AniLink onClick={goBack} to="/concept" className={css(headerStyles.blue_text, headerStyles.topic)}><b>concept</b></AniLink></li>
            <div className={css(headerStyles.work_items)}>
              <li className={css(headerStyles.topic)}><b>work</b></li>
                <ul>
                  ...
                  <li className={css(headerStyles.last_item)}><AniLink onClick={goBack} to="/brand-identity-trader-joes" className={css(headerStyles.blue_text, headerStyles.work_item)}>Trader Joes</AniLink></li>
            ...
            <li><AniLink onClick={goBack} to="/clients" className={css(headerStyles.blue_text, headerStyles.topic)}><b>clients</b></AniLink></li>
            <li><AniLink onClick={goBack} to="/contact" className={css(headerStyles.blue_text, headerStyles.topic)}><b>contact</b></AniLink></li>
          </ul>
        </div>
      </div>
    )
    ...
    return(
      menu === "" ?
        <svg className={css(headerStyles.menu_button)} mode="multiply" viewBox="0 0 29 21" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={goToMenu}>
          <path d="M1 1H27.3415" stroke="black" strokeWidth="2" strokeLinecap="round"/>
          <path d="M1 10.5H28" stroke="black" strokeWidth="2" strokeLinecap="round"/>
          <path d="M1.65854 20H28" stroke="black" strokeWidth="2" strokeLinecap="round"/>
        </svg>
      :
        <svg className={css(headerStyles.exit_button)} viewBox="0 0 30 23" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={goBack}>
          <path d="M1 3L28.5 22" stroke="black" strokeWidth="2" strokeLinecap="round"/>
          <path d="M1.65854 22L27 1.5" stroke="black" strokeWidth="2" strokeLinecap="round"/>
        </svg>
    )
  }

  const instButton =
    <a href="https://www.instagram.com/caspartpackaging/" target="_blank">
      <img src={instagramLogo} className={css(headerStyles.instagram_button)}/>
    </a>

  const fbButton =
    <a href="https://www.facebook.com" target="_blank">
      <img src={facebookLogo} className={css(headerStyles.facebook_button)}/>
    </a>
