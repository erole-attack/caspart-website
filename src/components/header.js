    ...
    setMenu(
      <div className={css(headerStyles.menu)}>
        ...
        <ul className={css(headerStyles.menu_items)}>
          <li><AniLink to="/concept" className={css(headerStyles.blue_text, headerStyles.topic)}><b>concept</b></AniLink></li>
          <div className={css(headerStyles.work_items)}>
            <li className={css(headerStyles.topic)}><b>work</b></li>
              <ul>
                ...
                <li><AniLink to="/brand-identity-delicono" className={css(headerStyles.blue_text, headerStyles.work_item)}>Delicono</AniLink></li>
                <li><AniLink to="/brand-identity-moony" className={css(headerStyles.blue_text, headerStyles.work_item)}>Moony Cakes</AniLink></li>
                <li className={css(headerStyles.last_item)}><AniLink to="/brand-identity-trader-joes" className={css(headerStyles.blue_text, headerStyles.work_item)}>Trader Joes</AniLink></li>
