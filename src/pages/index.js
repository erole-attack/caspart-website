...
export const indexImageQuery = graphql`
  query {
    ...
    engelMobile: file(relativePath: { eq: "grote-engel.png" }) {
      childImageSharp {
        fluid(maxWidth: 200) {
          ...GatsbyImageSharpFluid_withWebp
        }
